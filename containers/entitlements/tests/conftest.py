...
def get_override_token():
    ...
    return {
        ...
        "aud": ["tdf-entitlement", "tdf-attributes", "realm-management", "account"],
        "sub": "0e56dae3-70bf-4f2a-a919-a58e7807ef53",
        "typ": "Bearer",
        "azp": "tdf-client",
        "session_state": "ea78a1d0-5c04-416f-b842-a69c2f2471cd",
        "acr": "1",
        "allowed-origins": ["http://localhost:65432"],
        "realm_access": {
            "roles": ["default-roles-tdf", "offline_access", "uma_authorization"]
        },
        "resource_access": {
            "realm-management": {
                "roles": [
