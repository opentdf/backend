...
BASE_AUDIT_LOG = {
    "id": "TEST_UUID",
    "transaction_timestamp": "NOW_DATETIME",
    "tdf_id": "",
    "tdf_name": None,
    "owner_id": "",
    "owner_org_id": None,
    "transaction_type": "testint",
    "action_type": "testint",
...
def test_extract_info_from_auth_token():
    ...
    assert new_audit_log["owner_id"] == "3cba8d86-1654-419f-8e68-1788e7d69fa3"

    assert new_audit_log["actor_attributes"]["npe"] == True
    assert new_audit_log["actor_attributes"]["actor_id"] == "tdf-client"
    assert set(new_audit_log["actor_attributes"]["attrs"]) == set(
        [
