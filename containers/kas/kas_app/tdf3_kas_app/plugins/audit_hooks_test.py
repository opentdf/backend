...
def test_extract_info_from_auth_token():
    ...
    assert new_audit_log["owner"]["id"] == "3cba8d86-1654-419f-8e68-1788e7d69fa3"

    assert new_audit_log["actor"]["id"] == "tdf-client"
    assert set(new_audit_log["actor"]["attributes"]["attrs"]) == set(
        [
