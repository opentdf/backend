...
COPY --from=policy-builder --chown=10001:10001 /opt/app-root/src/bundle.tar.gz $OPA_POLICYBUNDLE_PATH
COPY --from=policy-builder --chown=10001:10001 /opt/app-root/src/opa-config.yaml $OPA_CONFIG_PATH
# service
